...
const CardList = [
    ...
    {index:5, title:"Sushi is a traditional Japanese dish of prepared vinegared rice, usually with some sugar and salt, accompanied by a variety of ingredients, such as seafood ....", url:one},
    {index:6, title:"The bottom of the pizza, called the crust, may vary widely according to style – thin as in a typical hand-tossed Neapolitan pizza or thick as in a deep-dish ...", url:two},
    {index:7, title:"Masala pasta recipe made in Indian style with Indian spices, herbs, mix veggies & pasta.This super delicious dish is kids' friendly & can be ...", url:three},
    {index:8, title:"These super moist chocolate cupcakes pack TONS of chocolate flavor in each cupcake wrapper! Made from simple everyday ingredients, this easy cupcake recipe will be your new favorite. ", url:four},
]
